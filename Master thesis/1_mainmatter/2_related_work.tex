...
\section{Assimilating Agents and AOP}
...
\subsubsection{Exploring AOP from an OOP perspective}
...
\subsubsection{\ac{BDI} Agent Programming in AgentSpeak Using JASON}
...
\subsubsection{Domain specific agent-oriented programming language based on the Xtext framework}
...
\subsubsection{Agent-Oriented Supply-Chain Management}
...
\subsubsection{From Agents to Blockchain: Stairway to Integration}
...
\subsubsection{Decentralized Execution of Smart Contracts: Agent Model Perspective and Its Implications}
...
\subsubsection{MAS and Blockchain: Results from a Systematic Literature Review}
